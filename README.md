...
## 📚 Contents
- [`docs/00-overview.md`](docs/00-overview.md) — What’s inside & how to use these guides
- [`docs/01-ssh-and-git.md`](docs/01-ssh-and-git.md) — SSH keys, Git config, GitHub/42 Intra, GPG (optional)
